from backend.ai.llm.prompts import SGK_AGENT_SYSTEM_PROMPT_JSON
...
def sgk_agent(llm_name, query, options):
    ...
    response: RagResponse = rag_invoke(llm_name, SGK_AGENT_SYSTEM_PROMPT_JSON, vector_db, SKG_AGENT_SIMILAR_VECTOR_K, query, options, VECTOR_DB_OPTION)
