...
MIXEDBREAD_AI_MXBAI_RERANK_BASE_V1 = "mixedbread-ai/mxbai-rerank-base-v1"
BAAI_BGE_RERANKER_V2_M3 = "BAAI/bge-reranker-v2-m3"
ALIBABA_NLP_GTE_MULTILINGUAL_RERANKER_BASE = "Alibaba-NLP/gte-multilingual-reranker-base"

# Options for LLM
CROSS_ENCODER_OPTION = "CE"
SELF_RAG_OPTION = "SELF_RAG"
